...
r1_X_Y_data_NumOne, r2_X_Y_data_NumOne, r3_X_Y_data_NumOne = open('CommonProblem/Coords/coord0_NumOne.txt', 'r').read(), open(
        'CommonProblem/Coords/coord1_NumOne.txt', 'r').read(), open('CommonProblem/Coords/coord2_NumOne.txt', 'r').read()
