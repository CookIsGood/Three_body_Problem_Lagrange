...
r1_X_Y_data = open('Eyler/Coords/coord0_NumOne.txt', 'r').read()
r2_X_Y_data = open('Eyler/Coords/coord1_NumOne.txt', 'r').read()
r3_X_Y_data = open('Eyler/Coords/coord2_NumOne.txt', 'r').read()
v1_X_Y_data = open('Eyler/Coords/speed0_NumOne.txt', 'r').read()
v2_X_Y_data = open('Eyler/Coords/speed1_NumOne.txt', 'r').read()
v3_X_Y_data = open('Eyler/Coords/speed2_NumOne.txt', 'r').read()
...
text_file = open("Eyler/Coords/coord0_NumThree.txt", "w")
text_file1 = open("Eyler/Coords/coord1_NumThree.txt", "w")
text_file2 = open("Eyler/Coords/coord2_NumThree.txt", "w")
