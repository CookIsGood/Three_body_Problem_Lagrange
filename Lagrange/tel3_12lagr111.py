...
r1_X_Y_data = open('Lagrange/Coords/coord01.txt', 'r').read()
r2_X_Y_data = open('Lagrange/Coords/coord02.txt', 'r').read()
v1_X_Y_data = open('Lagrange/Coords/speed01.txt', 'r').read()
v2_X_Y_data = open('Lagrange/Coords/speed02.txt', 'r').read()
...
c_data= c3[0]/c3
text_file10 = open("Lagrange/Coords/k_NumTwo.txt", "w")
text_file11 = open("Lagrange/Coords/H_NumTwo.txt", "w")
text_file12 = open("Lagrange/Coords/C_NumTwo.txt", "w")
...
text_file = open("Lagrange/Coords/coord0_NumTwo.txt", "w")
text_file1 = open("Lagrange/Coords/coord1_NumTwo.txt", "w")
text_file2 = open("Lagrange/Coords/coord2_NumTwo.txt", "w")
