...
def _useParams():
    ...
    text_file,text_file1,text_file2,text_file3,text_file4 = open("Params/M0-M1.txt", "w"),open("Params/M2-f.txt", "w"),open("Params/c-e.txt", "w"),open("Params/F-vp.txt", "w"),open("Params/steps-t.txt", "w")
...
def _start_grath():
    ...
    r1_X_Y_data_NumThree, r2_X_Y_data_NumThree, r3_X_Y_data_NumThree = open('Coords/coord0_NumThree.txt', 'r').read(), open(
